          ...
          <div className="bg-gray-100 p-4 border-t-2 bg-opacity-5 border-indigo-400 rounded-t">
            <div className="max-w-sm mx-auto md:w-full md:mx-0">
              <div className="inline-flex items-center space-x-4">
                ...
                <h1 className="text-gray-600">{props.nombre}</h1>
              </div>
            </div>
          </div>
          <div className="bg-white space-y-6">
            ...
            <div className="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-gray-500 items-center">
              ...
              <div className="md:w-3/12 text-center md:pl-6">
                <button className="text-white w-full hover:bg-green-600 mx-auto max-w-sm rounded-md text-center bg-indigo-400 py-2 px-4 inline-flex items-center focus:outline-none md:float-right">
                  <svg
                    fill="none"
